      ...
      <div class="mt-28 flex justify-center">
        <div class="bg-white w-fit px-16 py-5 rounded-xl shadow-md">
          ...
          <div class="flex justify-center">
            <button class="mr-2 bg-gray-200 px-8 rounded-md font-bold">Guru</button> 
          ...
          <form action="">
              <div class="flex py-2 pt-4">
                ...
                <input type="text" placeholder="Masukkan NIP" class="bg-gray-200 px-2 rounded-md w-64 h-8">
              </div>
          </form>
          <form action="">
              <div class="flex py-2">
